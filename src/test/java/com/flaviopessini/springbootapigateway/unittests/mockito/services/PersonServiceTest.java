package com.flaviopessini.springbootapigateway.unittests.mockito.services;

import com.flaviopessini.springbootapigateway.dtos.v1.PersonDTO;
import com.flaviopessini.springbootapigateway.exceptions.RequiredObjectIsNullException;
...
public class PersonServiceTest {
    ...
    void testFindById() {
        ...
        assertEquals("Address 0", result.getAddress());
        assertEquals("First name 0", result.getFirstName());
        assertEquals("Last name 0", result.getLastName());
